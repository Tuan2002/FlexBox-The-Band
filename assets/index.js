const clickBtns = document.querySelectorAll('.ticket-info__buy-ticket');
...
//  Automatic hide menu when click on it
const menuItems = document.querySelectorAll('.nav-bar__item a[href^="#"]');
